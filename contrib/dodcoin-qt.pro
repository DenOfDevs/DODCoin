...
RESOURCES += src/qt/dodcoin.qrc src/qt/dodcoin_locale.qrc

TRANSLATIONS += src/qt/locale/dodcoin_bg.ts \
                src/qt/locale/dodcoin_de.ts \
                src/qt/locale/dodcoin_en.ts \
                src/qt/locale/dodcoin_es.ts \
                src/qt/locale/dodcoin_fi.ts \
                src/qt/locale/dodcoin_fr.ts \
                src/qt/locale/dodcoin_it.ts \
                src/qt/locale/dodcoin_ja.ts \
                src/qt/locale/dodcoin_pl.ts \
                src/qt/locale/dodcoin_pt.ts \
                src/qt/locale/dodcoin_ru.ts \
                src/qt/locale/dodcoin_sk.ts \
                src/qt/locale/dodcoin_sv.ts \
                src/qt/locale/dodcoin_vi.ts \
                src/qt/locale/dodcoin_zh_CN.ts \
                src/qt/locale/dodcoin_zh_TW.ts
