...
In order to support loading of multiple wallets in dodcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dodcoin.cpp.
...
Changes to dodcoin.cpp
----------------------
dodcoin.cpp is the entry point into dodcoin-qt, and as such, will require some minor modifications to provide hooks for
