...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DODcoin Core dodcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dodcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dodcoin transaction") + "\n" +
                               "  dodcoin-tx [options] -create [commands]   " + _("Create hex-encoded dodcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dodcoin transaction
