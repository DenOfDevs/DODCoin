...
/** Utility functions used by the DODcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DODcoin addresses in monospace font
...
// Parse "dodcoin:" URI into recipient object, return true on successful parsing
