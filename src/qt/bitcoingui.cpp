                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DODcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DODcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dodcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDOD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DODcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about DODcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DODcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DODcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DODcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a DODcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DODcoin Core help message to get a list with possible DODcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DODcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DODcoin network", "", count));
}
...
{
    QString strTitle = tr("DODcoin Core"); // default title
...
/** Creates context menu, its actions, and dodcoins up all the relevant signals for mouse events. */
