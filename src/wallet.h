...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 DODCOIN at the same time
...
enum ZerocoinSpendStatus {
    ZDODCOIN_SPEND_OKAY = 0,                            // No error
    ZDODCOIN_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZDODCOIN_WALLET_LOCKED = 2,                         // Wallet was locked
    ZDODCOIN_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZDODCOIN_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZDODCOIN_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZDODCOIN_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZDODCOIN_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZDODCOIN_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZDODCOIN_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZDODCOIN_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZDODCOIN_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZDODCOIN_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZDODCOIN_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZDODCOIN_SPENT_USED_ZDODCOIN = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZDODcoinAutoBackups(bool fEnabled)
    {
