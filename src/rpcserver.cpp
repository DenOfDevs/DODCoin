...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "DODcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DODcoin features */
        {"dodcoin", "masternode", &masternode, true, true, false},
        {"dodcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"dodcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dodcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dodcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dodcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"dodcoin", "startmasternode", &startmasternode, true, true, false},
        {"dodcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dodcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dodcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dodcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dodcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dodcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dodcoin", "mnbudget", &mnbudget, true, true, false},
        {"dodcoin", "preparebudget", &preparebudget, true, true, false},
        {"dodcoin", "submitbudget", &submitbudget, true, true, false},
        {"dodcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dodcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dodcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dodcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dodcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dodcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dodcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dodcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"dodcoin", "mnsync", &mnsync, true, true, false},
        {"dodcoin", "spork", &spork, true, true, false},
        {"dodcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dodcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dodcoind, or the -server option to dodcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dodcoin-cli " + methodname + " " + args + "\n";
}
