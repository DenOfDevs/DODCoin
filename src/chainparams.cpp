...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000797e0cbd087ee2735c6021e0ac29d14ab4a271e313da0e491998d1e6c53"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1541832774, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04d0cba9ccc90ee854b2a702e9d5891d8a90165554eac9db2963de6709dd2aae2e562ec12b46b38ad170114e2bb425edcb7801b0a600ca5828a1dddececce490c6");
        nDefaultPort = 5674;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // DODcoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 5 * 60; // DODcoin: 5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // DODcoin: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // DODcoin: 60 Seconds
        nMaturity = 15;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "DODcoin new blockchain is here";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0438acafac4f24d502fd9818155bb5859ee17c1f10cdd25c4ca0e5fd714c863ae5953f7ce32826503a15835d8709dfb0645f7bac5fa0266608d0ac566f92cfd354") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1541832774;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 4187186;
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 90); // v
	    ...
	    strSporkKey = "043842f7197bdf94c591b3b9a0113a419f2f567ff2d55f2865de6e748aee042ce9361484f961ddad64cad404bd324e1eb96a782ac662b2fbd5f1635e21d24342dc";
        strObfuscationPoolDummyAddress = "GfLRuhBWpz8N2Hp4t6zEmSKYEqL2dpmsqu";
        nStartMasternodePayments = 5000; // Block 5000
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // DODcoin: 1 day
        nTargetSpacing = 1 * 60;  // DODcoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet dodcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet dodcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet dodcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet dodcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet dodcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // DODcoin: 1 day
        nTargetSpacing = 1 * 60;        // DODcoin: 1 minutes
