Contributing to DODcoin Core
============================

The DODcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DODcoin Core project, and is not to be
confused with overall DODcoin Network Protocol consensus changes.

Whether a pull request is merged into DODcoin Core rests with the project merge
...
Patches that change DODcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the DODcoin consensus, it must have been
...
The project leader is the release manager for each DODcoin Core release.
